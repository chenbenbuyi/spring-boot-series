...
public class UserController {
    ...
    ExecutorService executorService = new ThreadPoolExecutor(1, 1, 0L, TimeUnit.SECONDS, new LinkedBlockingQueue<>(1));
    ...
    public Result<UserEntity> save(UserEntity user) {
        List<String> list = Arrays.asList("sdsd");
        HashMap<Object, Object> map = new HashMap<>();
        map.put("水电费水电费", "sdfgsdf");
        list.forEach(e -> {
            Callable callable = () -> {
